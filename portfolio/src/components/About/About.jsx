    ...
    <section id="about" className="section about" ref={ref}>
      <div className="container">
        <div className="about__header">
          <motion.div className="section-tag" variants={fadeUp} initial="hidden" animate={inView ? 'show' : 'hidden'}>
            About Me
          </motion.div>
        ...
        <div className="about__grid">
          ...
          <motion.div
            ...
            variants={fadeUp} custom={3} initial="hidden" animate={inView ? 'show' : 'hidden'}
          >
